...
//  FoodTracker
//
//  Created by Rio Michelini on 25/02/2021.
//
import UIKit
import os.log
...
class MealTableViewController: UITableViewController {
	...
	private func saveMeals() {
		if let dataArchive = try? NSKeyedArchiver.archivedData(withRootObject: meals, requiringSecureCoding: false) {
			try? dataArchive.write(to: Meal.archiveURL)
